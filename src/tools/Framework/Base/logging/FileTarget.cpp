...
void FileTarget::log(Level level, const char* functionName, const char* logstr) const
{
...
void FileTarget::log(Level level, const char* functionName, std::exception exception, const char* logstr) const
{
