...
#include "vulkan/shader_parser/SPIRVReflection.h"
#include "vulkan/shader_parser/GLSLCompiler.h"
    ...
    m_resources()
{
    ...
    if( !compileSuccess )
    {
        ...
        throw new VulkanException("Shader compilation failed. See above for details.");
    }
